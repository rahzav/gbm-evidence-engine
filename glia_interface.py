...
export default function(component) {
  ...
  const syncWorkspaceLayout = () => {
    ...
    if (runtime.open && !runtime.expanded && window.innerWidth > 980) {
      target.style.width = "calc(100% - 440px)";
      target.style.maxWidth = "calc(100% - 440px)";
      target.style.marginRight = "440px";
...
def _quick_actions(active_workflow: str) -> list[str]:
    mapping = {
        "Gene Analysis": [
            "What is the strongest decision-relevant signal?",
            "What is the strongest reason this target could fail?",
            "What is the highest-information next experiment?",
        ],
        "Target Pair Analysis": [
            "What is the strongest reason this pair could fail?",
            "What is the decisive reason to test this combination?",
            "What is the cleanest validation sequence?",
        ],
        "Researcher Data": [
            "Which signal is most worth validating?",
            "What could be a false lead in these results?",
            "What experiment best separates the leading hypotheses?",
        ],
        "Gene Set Comparison": [
            "Which target should move forward first?",
            "What evidence most changes the ranking?",
            "Which two targets are most worth comparing experimentally?",
        ],
        "Methods & Data Sources": [
            "What can this evidence establish?",
            "What can this evidence not establish?",
            "Which source matters most for this question?",
        ],
    }
